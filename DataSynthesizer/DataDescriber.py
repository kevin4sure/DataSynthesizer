...
class DataDescriber:
    ...
    def __init__(self, histogram_bins: Union[int, str] = 20, category_threshold=10000, null_values=None):
    ...
    def inject_laplace_noise_into_distribution_per_attribute(self, epsilon=0.0):
