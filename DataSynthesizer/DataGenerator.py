...
if __name__ == '__main__':
    ...
    # dataset_description_fileIP = r'C:\Users\dhgade\Documents\HealthDataGenerat_Repo\synthetic-data-tutorial\data'
    ...
    # df = pd.read_csv (dataset_description_fileIP+r'\datasets_228_482_diabetes.csv')
    # df.to_json(dataset_description_fileIP+r'\datasets_228_482_diabetes.json')
    # dataset_description_file = dataset_description_fileIP+r'\datasets_228_482_diabetes.json'
